  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const GameScreen(
        currentChallenge: {
          "description": "Complete the Python function to add two numbers.",
          "code_snippet": "def add_numbers(a, b):\n  return ___ + ___",
          "place_holder_to_replace": "___",
          "words": ["a", "b", "c", "print", "return", "+"],
          "solution": ["a", "b"],
        },
      ),
    );
...
class GameScreen extends StatefulWidget {
  ...
  const GameScreen({super.key, required this.currentChallenge});
...
class _GameScreenState extends State<GameScreen> {
  ...
  Widget _buildCodeSnippet() {
    String originalSnippet = widget.currentChallenge['code_snippet'];
    List<String> parts = originalSnippet.split(
      widget.currentChallenge['place_holder_to_replace'],
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(widget.currentChallenge['description']),
  ...
  void _checkSolution() {
    ...
    final isCorrect = const ListEquality().equals(
      userSolution,
      widget.currentChallenge['solution'],
    );
    setState(() {
    ...
    if (isCorrect) {
      print("correct answer selected"); // Load a new challenge on success
    }
  }
}
